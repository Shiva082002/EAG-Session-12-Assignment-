...
from browser_agent.browserAgent import BrowserAgent, create_browser_agent
from browser_agent.browser_tasks import Browser
...
class newagentloop4:
    ...
    def __init__(self, perception_prompt, decision_prompt, summarizer_prompt, browser_prompt, multi_mcp, strategy="exploratory"):
        ...
        self.logger = logging.getLogger("newagentloop4")
...
"""
    ...
    async def _extract_browser_tasks(self, query: str, error: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            tasks = await self.browser.new_genrate_task(query, context, error)
